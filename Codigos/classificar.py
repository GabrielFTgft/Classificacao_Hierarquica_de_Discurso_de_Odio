import pandas as pd
df = pd.read_csv('C:\\Users\\marde\\OneDrive\\Documentos\\CC\\Mineracao_de_Dados\\dataset_Paula_Fortuna\\TESTE_portuguese_hate_speech_hierarchical_classification.csv')
